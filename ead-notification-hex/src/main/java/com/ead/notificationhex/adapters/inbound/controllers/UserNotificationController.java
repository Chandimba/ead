...
public class UserNotificationController {
    ...
    public ResponseEntity<Page<NotificationDomain>> getAllNotificationsByUser(
        ...
        List<NotificationDomain> notifications = notificationService.findAllNotificationsByUser(userId, pageInfo);
        PageImpl<NotificationDomain> notificationDomainPage = new PageImpl<>(notifications, pageable, notifications.size());
    ...
    public ResponseEntity<Object> updateNotification(@PathVariable UUID userId,
        ...
        notificationService.saveNotification(NotificationDomainOptional.get());
